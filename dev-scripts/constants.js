...
export const generateRandomInt = (min = 1000, max = 9999) => randomInt(min, max);

// Creative modifiers for topic generation
const CREATIVE_MODIFIERS = [
  "unexpected angle", "personal story", "behind-the-scenes", "myth-busting",
  "beginner-friendly", "advanced technique", "common mistake", "success story",
  "seasonal twist", "cultural perspective", "historical context", "future-focused",
  "practical tip", "emotional connection", "scientific approach", "creative method",
  "step-by-step guide", "expert insight", "real-world example", "quick win",
  "deep dive", "contrarian view", "trending topic", "evergreen wisdom",
  "case study", "pro tip", "hidden gem", "industry secret",
  "beginner mistake", "expert level", "time-saving hack", "game-changer",
  "underrated approach", "overrated myth", "insider knowledge", "fresh perspective"
];
...
export const generateRandomModifiers = () => {
  ...
  return Array.from(indices).map(i => CREATIVE_MODIFIERS[i]).join(', ');
};
